...
```ds
fn ThemeProvider(props: ShellProps) ReactNode {
...
The theme island is where those two worlds meet. The document can ship `data-theme="light"` without JS; the island writes the preference once a human asks.
