#!/usr/bin/env bash
# Fetch the authoritative conformance corpus for CI. The tag is reviewed in a
# dedicated pin bump; SHA-256 verification prevents a changed archive from
# silently red-ing an unrelated runtime PR.
set -euo pipefail
