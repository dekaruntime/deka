#!/usr/bin/env bun
// Native Hats runner. Loads an authoritative corpus <category>/<name>/ and executes
...
function registryInstallBlockReason(error) {
...
function printUsage() {
  console.log(`usage: bun scripts/testsuite-run.mjs --root <corpus> [options]
