...
const STRUCT_HEAD: &str = "function __deka_struct(id,embeds){function f(fields){const o=Object.create(f.prototype);Object.assign(o,fields);return o;}f.id=id;Object.defineProperty(f,'name',{value:id,configurable:true});f.prototype=Object.create(null);Object.defineProperty(f.prototype,'__deka_struct',{value:id,enumerable:false,writable:false,configurable:false});f.prototype.constructor=f;";
