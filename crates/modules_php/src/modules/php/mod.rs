...
deno_core::extension!(
    ...
    ops = [
        ...
        crypto_env::op_php_hmac,
        crypto_env::op_php_secure_compare,
        crypto_env::op_php_aes_256_gcm_encrypt,
        crypto_env::op_php_aes_256_gcm_decrypt,
        crypto_env::op_php_bcrypt_verify,
        crypto_env::op_php_read_env,
