...
const WORKSPACE_VERSION_PLACEHOLDER: &str = "<workspace-version>";
...
fn normalize_manifest_bytes(bytes: &[u8]) -> Result<Vec<u8>, String> {
...
fn manifest_bytes_match(expected: &[u8], actual: &[u8]) -> Result<(), String> {
...
fn normalized_manifest_anchor(manifest_bytes: &[u8]) -> Result<String, String> {
...
fn check_producer_version(manifest: &serde_json::Value) -> Result<(), String> {
