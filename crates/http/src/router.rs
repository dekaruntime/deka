...
mod tests {
    ...
    fn hmr_client_imports_hydrate_from_ui_client_module() {
        ...
        // as the ui/client module, not as a window.deka.ui global. The
        // URL matches the islands entries' "./ui/client.js" import so the
        // module instance (and island registry) is shared.
        assert!(out.contains("<script id=\"__deka_hmr_client\" type=\"module\">"));
        assert!(out.contains("import(\"/assets/ui/client.js\")"));
