 ...
 * Upstream: https://cdn.jsdelivr.net/npm/react-refresh@0.17.0/cjs/react-refresh-runtime.development.js
 * sha256: 5ae1a9f8ee9e5472e3e3e19eccf52d535941de3bd7d670af71a0bc78db05f6e8
...
export default __m;
export const _getMountedRootCount = __m._getMountedRootCount;
export const collectCustomHooksForSignature = __m.collectCustomHooksForSignature;
export const createSignatureFunctionForTransform = __m.createSignatureFunctionForTransform;
export const getFamilyByID = __m.getFamilyByID;
export const getFamilyByType = __m.getFamilyByType;
export const hasUnrecoverableErrors = __m.hasUnrecoverableErrors;
export const injectIntoGlobalHook = __m.injectIntoGlobalHook;
export const isLikelyComponentType = __m.isLikelyComponentType;
export const performReactRefresh = __m.performReactRefresh;
export const register = __m.register;
export const setSignature = __m.setSignature;
