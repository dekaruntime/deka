...
mod tests {
    use super::{
        collect_project_install_specs, enqueue_package_spec, locked_package, package_dependencies, pause_for_kill_test, php_modules_path_for, recover_install_transaction, rehash_php_packages_in, reject_vendored_php_modules, run_php_install_in, verify_locked_integrity, InstallTransaction, InstalledSource, LockedPackage,
    };
